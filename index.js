...
let player = new Player(x, y, 2, 'lightsteelblue')
let projectiles = []
let enemies = []
let particles = []

function init() {
  player = new Player(x, y, 2, 'lightsteelblue')
  projectiles = []
  enemies = []
  particles = []
  score = 0
...
class Blast {
  ...
  draw() {
    c.beginPath()
    c.arc(this.radius, 0, Math.PI * 2, false)
  }
  update() {
...
const rb = new Blast(canvas.width / 2, canvas.height / 2, 50, 'blue')
